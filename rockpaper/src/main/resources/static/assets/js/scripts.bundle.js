			...
			insertData: function() {
				...
				$.each(datatable.dataSet, function(rowIndex, row) {
					...
					for (var a = 0; a < colLength; a += 1) {
						...
						td.setAttribute('title', Plugin.getObject(column.field, row));
						tr.appendChild(td);
					}
...
KTUtil.ready(function() {
    ...
    // Init User Panel For Logo
    if (typeof KTLayoutUser !== 'undefined') {
        KTLayoutUser.init('kt_user');
    }
		...
		if (KTUtil.attr(_element, 'data-menu-scroll') === '1') {
			scroll = {
				...
				height: function() { // Calculate available scrollable area height
					...
					height = height - KTLayoutBrand.getHeight() - KTLayoutUser.getHeight();
