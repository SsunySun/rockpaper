...
import kr.co.rockplace.rshm.service.admin.CodeTypeService;
...
public class CodeController extends AdminCommonController<CodeEntity> {
	...
	public String create(
		...
		// Form Elements
		model.addAttribute("codeTypeList", this.codeTypeService.getList());
