...
public class FormController extends AdminCommonController<FormEntity> {
	...
	public String create(
		...
		TableFieldEntity tableFieldEntity = this.tableFieldService.getObject("TAB_FORM/TYPE_CD");
