...
public class EntityController extends AdminCommonController<EntityEntity> {
	...
	public String create(
		...
		TableFieldEntity tableFieldEntity = this.tableFieldService.getObject("TAB_ENTITY/TYPE_CD");
		model.addAttribute("typeList", tableFieldEntity.getRefCtyCodeTypeEntity().getCodeEntityList());
