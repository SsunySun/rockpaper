...
public class TableController extends AdminCommonController<TableEntity> {
	...
	public String create(
		...
		TableFieldEntity tableFieldEntity = this.tableFieldService.getObject("TAB_TABLE/TYPE_CD");
